Built a "simple" Sudoku game where the objective is to fill in a 9×9 square with numbers from 1-9 with no repeated numbers in each line, horizontally or vertically.
